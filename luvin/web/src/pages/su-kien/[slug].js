...
import { getEvent, joinEventError, resetState } from "../../actions/event";

const eventStateSelector = (state) => state.event;

function DetailEvent({ eventSlug }) {
  const dispatch = useDispatch();
  const { event, loading, fetched, errorMessage, joinEvent = {} } = useSelector(
    eventStateSelector
  );
  ...
  return (
    <Content className="post-template-default single single-post postid-422 single-format-standard wp-custom-logo theme-hello-elementor woocommerce-no-js elementor-default elementor-kit-76 elementor-page-589">
      ...
      {(loading || joinEvent.loading) && <Loading />}
      <div className="elementor elementor-589 elementor-location-single post-422 post type-post status-publish format-standard has-post-thumbnail hentry category-su-kien tag-su-kien-sap-toi">
        <div className="elementor-section-wrap">
          <section className="elementor-section elementor-top-section elementor-element elementor-element-49ca5c1 elementor-section-boxed elementor-section-height-default elementor-section-height-default">
            <div className="elementor-container elementor-column-gap-default">
              <div className="elementor-row">
                <div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-e50713a">
          ...
          <section className="elementor-section elementor-top-section elementor-element elementor-element-18eff56 elementor-section-boxed elementor-section-height-default elementor-section-height-default">
            <div className="elementor-container elementor-column-gap-extended">
              <div className="elementor-row">
                <div
                  className={`elementor-column elementor-top-column elementor-element elementor-element-7b0f2a5 ${
                    isOccurred ? "elementor-col-100" : "elementor-col-66"
                  }`}
                >
                  <div className="elementor-column-wrap elementor-element-populated">
                    <div className="elementor-widget-wrap">
                      <div className="elementor-element elementor-element-6460c8d elementor-widget elementor-widget-theme-post-content">
                        <div
                ...
                {!isOccurred && (
                  <div className="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-7427782">
                    <div className="elementor-column-wrap elementor-element-populated">
                      <div className="elementor-widget-wrap">
                        <div className="elementor-element elementor-element-eacfae6 elementor-widget elementor-widget-heading">
                          <div className="elementor-widget-container">
                        ...
                        <div className="elementor-element elementor-element-0d652e3 elementor-button-align-stretch elementor-widget elementor-widget-form">
                          <div className="elementor-widget-container">
                            <form
                            ...
                            >
                              <div className="elementor-form-fields-wrapper elementor-labels-">
                                ...
                                <div className="elementor-field-type-tel elementor-field-group elementor-column elementor-field-group-field_56d860a elementor-col-100 elementor-field-required">
                                  <label
          ...
          <section className="elementor-section elementor-top-section elementor-element elementor-element-693b1af elementor-section-boxed elementor-section-height-default elementor-section-height-default">
            <div className="elementor-container elementor-column-gap-default">
              <div className="elementor-row">
                <div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-1ab82c2">
                  <div className="elementor-column-wrap elementor-element-populated">
                    <div className="elementor-widget-wrap">
...
DetailEvent.getInitialProps = async (props) => {
  ...
  store.dispatch(getEvent(eventSlug));
  return { eventSlug };
};
