...
import { search, resetState } from "../actions/search";
...
function Search({ name }) {
  ...
  useEffect(() => {
    if (Search.isRendered) {
      dispatch(search(router.query.name, 12, 1));
    }
    Search.isRendered = true;
  }, [router.query.name]);

  return (
    <Content className="archive search search-results post-type-archive post-type-archive-product wp-custom-logo theme-hello-elementor woocommerce woocommerce-page woocommerce-no-js elementor-default elementor-template-full-width elementor-kit-76 elementor-page-653">
      ...
      <Head>
        <title>Tìm kiếm - Luvin</title>
        <meta property="og:type" content="website" />
        <meta property="og:title" content={`Tìm kiếm - Luvin`} />
      ...
      {loading && <Loading />}
      <div className="elementor elementor-653 elementor-location-archive product">
        <div className="elementor-section-wrap">
          <section className="elementor-section elementor-top-section elementor-element elementor-element-8c90302 elementor-section-boxed elementor-section-height-default elementor-section-height-default">
            <div className="elementor-container elementor-column-gap-default">
              <div className="elementor-row">
                <div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-4d16e4c">
                      ...
                      >
                        <div className="elementor-widget-container">
                          <h1 className="elementor-heading-title elementor-size-default">
                            Kết quả tìm kiếm {name || router.query.name}
                          </h1>
                        </div>
                      </div>
                    </div>
          ...
          <section className="elementor-section elementor-top-section elementor-element elementor-element-8a0c2c6 elementor-section-boxed elementor-section-height-default elementor-section-height-default">
            <div className="elementor-container elementor-column-gap-default">
              <div className="elementor-row">
                <div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-ea5be72">
                  <div className="elementor-column-wrap elementor-element-populated">
                    <div className="elementor-widget-wrap">
                      <div className="elementor-element elementor-element-7bfe303 search-results-box elementor-products-grid elementor-wc-products elementor-show-pagination-border-yes elementor-widget elementor-widget-wc-archive-products">
                        <div className="elementor-widget-container">
                            ...
                            {!!Math.ceil(total / limit) && (
                              <nav className="woocommerce-pagination">
                                <ReactPaginate
                                  ...
                                  onPageChange={(page) => {
                                    dispatch(
                                      search(name, limit, page.selected + 1)
                                    );
                                  }}
...
Search.getInitialProps = async (props) => {
  ...
  const { name } = query;
  if (!!req) {
    store.dispatch(search(name, 12, 1));
  }
  return { name };
};
