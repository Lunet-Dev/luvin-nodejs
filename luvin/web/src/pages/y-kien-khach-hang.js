...
function Feedback(props) {
  ...
  const handleSendFeedback = (event) => {
    ...
    dispatch(sendFeedbackAction(state));
  };

  return (
    <Content className="page-template-default page page-id-39 wp-custom-logo theme-hello-elementor woocommerce-no-js elementor-default elementor-kit-76 elementor-page elementor-page-39">
      ...
      >
        <div className="page-content">
          <div className="elementor elementor-39">
            <div className="elementor-inner">
              <div className="elementor-section-wrap">
                <section className="elementor-section elementor-top-section elementor-element elementor-element-f065f0d elementor-section-boxed elementor-section-height-default elementor-section-height-default">
                  <div className="elementor-container elementor-column-gap-default">
                    <div className="elementor-row">
                      <div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-937a5c5">
                        <div className="elementor-column-wrap elementor-element-populated">
                          <div className="elementor-widget-wrap">
                            <div className="elementor-element elementor-element-2c982e9 elementor-widget elementor-widget-heading">
                ...
                <section className="elementor-section elementor-top-section elementor-element elementor-element-c960cee elementor-section-boxed elementor-section-height-default elementor-section-height-default">
                  <div className="elementor-container elementor-column-gap-default">
                    <div className="elementor-row">
                      <div className="elementor-column elementor-col-66 elementor-top-column elementor-element elementor-element-e582b40">
                        <div className="elementor-column-wrap elementor-element-populated">
                          <div className="elementor-widget-wrap">
                            {feedbacks.map((feedback) => {
                              ...
                              return (
                                <section className="elementor-section elementor-inner-section elementor-element elementor-element-406935d tester-box elementor-section-boxed elementor-section-height-default elementor-section-height-default">
                                  <div className="elementor-container elementor-column-gap-default">
                                    <div className="elementor-row">
                                      <div className="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-7cdb0d7">
                                        <div className="elementor-column-wrap elementor-element-populated">
                                          <div className="elementor-widget-wrap">
                                            <div className="elementor-element elementor-element-6565513 elementor-widget elementor-widget-image">
                                              <div className="elementor-widget-container">
                                      ...
                                      <div className="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-84217ea">
                                        <div className="elementor-column-wrap elementor-element-populated">
                                          <div className="elementor-widget-wrap">
                                            <div className="elementor-element elementor-element-7474c7c elementor-widget elementor-widget-heading">
                                              <div className="elementor-widget-container">
                                            ...
                                            <div className="elementor-element elementor-element-03e3924 elementor-widget elementor-widget-heading">
                                              <div className="elementor-widget-container">
                                            ...
                                            <div className="elementor-element elementor-element-00794bf elementor-widget elementor-widget-heading">
                                              <div className="elementor-widget-container">
                                                <p className="elementor-heading-title elementor-size-default">
                                                  {description}
                                                </p>
                      ...
                      <div className="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-3a69962">
                        <div className="elementor-column-wrap elementor-element-populated">
                          <div className="elementor-widget-wrap">
                            <section className="elementor-section elementor-inner-section elementor-element elementor-element-0880130 elementor-section-boxed elementor-section-height-default elementor-section-height-default">
                              <div className="elementor-container elementor-column-gap-default">
                                <div className="elementor-row">
                                  <div className="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-42f1edf">
                                    <div className="elementor-column-wrap elementor-element-populated">
                                      <div className="elementor-widget-wrap">
                                        <div className="elementor-element elementor-element-64b1bab elementor-widget elementor-widget-heading">
                                          <div className="elementor-widget-container">
                                        ...
                                        <div className="elementor-element elementor-element-a8f3786 elementor-button-align-start elementor-widget elementor-widget-form">
                                          <div className="elementor-widget-container">
                                            <form
                                            ...
                                            >
                                              <div className="elementor-form-fields-wrapper elementor-labels-">
                                                ...
                                                <div className="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-field_aa8f54c elementor-col-100 elementor-field-required">
                                                  <label
                                                ...
                                                {/* <div className="elementor-field-type-upload elementor-field-group elementor-column elementor-field-group-field_75ba0f2 elementor-col-100">
                                                  <label
                                                    for="form-field-field_75ba0f2"
                                                    className="elementor-field-label elementor-screen-only"
                                                  >
                                                    Hình ảnh
                                                  </label>
                                                  <input
                                                    type="file"
                                                    name="form_fields[field_75ba0f2]"
                                                    id="form-field-field_75ba0f2"
                                        ...
                                        <div className="elementor-element elementor-element-840162d elementor-widget elementor-widget-heading">
                                          <div className="elementor-widget-container">
                                            <p className="elementor-heading-title elementor-size-default">
                                              *By submitting your details you
                                              consent to them being used in
                                              accordance with your preferences
                                              and our terms and conditions. Your
                                              data will not be shared with any
                                              third party without your prior
                                              consent and will be kept in
